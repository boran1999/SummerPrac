...
CAPNP_DECLARE_SCHEMA(ff989f0db21f4e4c);
CAPNP_DECLARE_SCHEMA(e156bc7e3a9f12f9);
CAPNP_DECLARE_SCHEMA(cbc7782a3727d432);
enum class Type_cbc7782a3727d432: uint16_t {
  MOBILE,
  HOME,
  WORK,
};
CAPNP_DECLARE_ENUM(Type, cbc7782a3727d432);
CAPNP_DECLARE_SCHEMA(e0afc7e1ced2e9b6);
CAPNP_DECLARE_SCHEMA(c27350e35cb21c38);
...
struct Person {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(ff989f0db21f4e4c, 1, 4)
    #if !CAPNP_LITE
...
struct Person::PhoneNumber {
  ...
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::Type_cbc7782a3727d432 Type;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(e156bc7e3a9f12f9, 1, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct Person::Employment {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(e0afc7e1ced2e9b6, 1, 4)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct AddressBook {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(c27350e35cb21c38, 0, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
